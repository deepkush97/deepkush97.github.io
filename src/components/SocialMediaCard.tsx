...
export const SocialMediaCard: FC<SocialMediaCardProps> = ({
  ...
  return (
    <a
      ...
      href={url}
      rel="noreferrer"
      className={`p-4 mx-3 w-1/4 flex flex-col justify-between  text-center rounded shadow-2xl ${classes.background.dark} hover:transform hover:scale-105 duration-200`}
      role="button"
    >
